...
!!! warning "Enabling the GPS-L5 Signal"
	...
	<figcaption markdown>Enabling the tracking and PVT use of signals from "unhealthy" satellites.</figcaption>
	</figure>
...
<figcaption markdown>[L5 Configuration - Step 2 (PNG)](./assets/img/hookup_guide/L5_step2.png).</figcaption>
</figure>
...
<figcaption markdown>[L5 Configuration - Step 3 (PNG)](./assets/img/hookup_guide/L5_step3.png).</figcaption>
</figure>
...
<figcaption markdown>[Advanced settings for RTCMv3 Data Formatting (PNG)](./assets/img/hookup_guide/RTCM_output_3.png).</figcaption>
</figure>
